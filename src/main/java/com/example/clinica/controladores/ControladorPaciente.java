...
public class ControladorPaciente {
    ...
    @PostMapping
    @Operation(summary = "Servicio para ingresar un paciente en base de datos")
@ApiResponses({
    ...
    @ApiResponse(responseCode = "400", description = "Datos invalidos en la petición",
...
//llamar al servicio para activar la busqueda de todos los pacientes
@GetMapping
    ...
    //llamar al serviciopara activar la busqieda por ID
@GetMapping(value = "/{id}")
